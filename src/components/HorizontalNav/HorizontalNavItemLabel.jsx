...
export class HorizontalNavItemLabel extends React.PureComponent {
  constructor(props) {
    super(props);
  ...
  render() {
    let props = {
      className: classNames('ds-c-Horizontal-nav__label', {
        'ds-c-Horizontal-nav__label--current': this.props.selected,
        'ds-c-Horizontal-nav__label--parent': this.props.hasSubnav,
      }),
...
export default HorizontalNavItemLabel;
